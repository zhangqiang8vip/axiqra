...
Good pull requests should include a short summary, the problem or workflow being improved, links to affected docs, security or privacy considerations, and examples when the change affects a schema, protocol, or workflow.
